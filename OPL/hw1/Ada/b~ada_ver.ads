...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_combinations" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ae37244a#;
   pragma Export (C, u00001, "test_combinationsB");
   ...
   u00103 : constant Version_32 := 16#58e7cff7#;
   pragma Export (C, u00103, "system__memoryB");
   u00104 : constant Version_32 := 16#3a5ba6be#;
